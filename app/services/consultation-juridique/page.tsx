...
export default function ConsultationJuridiquePage() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    consultationType: "Rédaction de contrats",
    description: "",
  })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const existingConsultations = localStorage.getItem("adminConsultations")
    ...
    localStorage.setItem("adminConsultations", JSON.stringify(consultations))
    ...
    setSubmitMessage("Votre demande a été envoyée avec succès ! Nous vous recontacterons rapidement.")
